...
process.ntupler = cms.EDAnalyzer('NtuplerMod',
  ...
  outputName    = cms.untracked.string('Bacon.root'),
  ...
  Electron = cms.untracked.PSet(
    ...
    eleIDFilenames = cms.untracked.vstring('../../CMSSW_7_3_3/src/BaconProd/Utils/data/ElectronID_BDTG_EGamma2012NonTrigV0_Cat1.weights.xml',
                                           '../../CMSSW_7_3_3/src/BaconProd/Utils/data/ElectronID_BDTG_EGamma2012NonTrigV0_Cat2.weights.xml',
					   '../../CMSSW_7_3_3/src/BaconProd/Utils/data/ElectronID_BDTG_EGamma2012NonTrigV0_Cat3.weights.xml',
					   '../../CMSSW_7_3_3/src/BaconProd/Utils/data/ElectronID_BDTG_EGamma2012NonTrigV0_Cat4.weights.xml',
					   '../../CMSSW_7_3_3/src/BaconProd/Utils/data/ElectronID_BDTG_EGamma2012NonTrigV0_Cat5.weights.xml',
					   '../../CMSSW_7_3_3/src/BaconProd/Utils/data/ElectronID_BDTG_EGamma2012NonTrigV0_Cat6.weights.xml'),
    ...
    eleEnergyRegWeights = cms.untracked.string('../../CMSSW_7_3_3/src/BaconProd/Utils/data/eleEnergyRegWeights_WithSubClusters_VApr15.root'),
    scalesCorr          = cms.untracked.string('../../CMSSW_7_3_3/src/BaconProd/Utils/data/scalesCorr.csv'),
    smearsCorrType1     = cms.untracked.string('../../CMSSW_7_3_3/src/BaconProd/Utils/data/smearsCorrType1.csv'),
    smearsCorrType2     = cms.untracked.string('../../CMSSW_7_3_3/src/BaconProd/Utils/data/smearsCorrType2.csv'),
    smearsCorrType3     = cms.untracked.string('../../CMSSW_7_3_3/src/BaconProd/Utils/data/smearsCorrType3.csv'),
    linearityCorr       = cms.untracked.string('../../CMSSW_7_3_3/src/BaconProd/Utils/data/linearityNewReg-May2013.csv')
  ),
  ...
  Tau = cms.untracked.PSet(
    ...
    ringIsoFile      = cms.untracked.string('../../CMSSW_7_3_3/src/BaconProd/Utils/data/gbrfTauIso_apr29a.root'),
    ringIso2File     = cms.untracked.string('../../CMSSW_7_3_3/src/BaconProd/Utils/data/gbrfTauIso_v2.root'),
  ...
  AK5 = cms.untracked.PSet(
    ...
    jecFiles = ( cms.untracked.vstring('../../CMSSW_7_3_3/src/BaconProd/Utils/data/Summer13_V1_DATA_L1FastJet_AK5PF.txt',
                                       '../../CMSSW_7_3_3/src/BaconProd/Utils/data/Summer13_V1_DATA_L2Relative_AK5PF.txt',
                                       '../../CMSSW_7_3_3/src/BaconProd/Utils/data/Summer13_V1_DATA_L3Absolute_AK5PF.txt',
                                       '../../CMSSW_7_3_3/src/BaconProd/Utils/data/Summer13_V1_DATA_L2L3Residual_AK5PF.txt')
                 if is_data_flag else
                 cms.untracked.vstring('../../CMSSW_7_3_3/src/BaconProd/Utils/data/Summer13_V1_MC_L1FastJet_AK5PF.txt',
                                       '../../CMSSW_7_3_3/src/BaconProd/Utils/data/Summer13_V1_MC_L2Relative_AK5PF.txt',
                                       '../../CMSSW_7_3_3/src/BaconProd/Utils/data/Summer13_V1_MC_L3Absolute_AK5PF.txt')
               ),
    jecUncFiles = ( cms.untracked.vstring('../../CMSSW_7_3_3/src/BaconProd/Utils/data/Summer13_V1_DATA_Uncertainty_AK5PF.txt')
                    if is_data_flag else
                    cms.untracked.vstring('../../CMSSW_7_3_3/src/BaconProd/Utils/data/Summer13_V1_MC_Uncertainty_AK5PF.txt')
                  ),
    jecFilesForID = ( cms.untracked.vstring('../../CMSSW_7_3_3/src/BaconProd/Utils/data/FT_53_V21_AN3_L1FastJet_AK5PF.txt',
                                            '../../CMSSW_7_3_3/src/BaconProd/Utils/data/FT_53_V21_AN3_L2Relative_AK5PF.txt',
                                            '../../CMSSW_7_3_3/src/BaconProd/Utils/data/FT_53_V21_AN3_L3Absolute_AK5PF.txt',
                                            '../../CMSSW_7_3_3/src/BaconProd/Utils/data/FT_53_V21_AN3_L2L3Residual_AK5PF.txt')
                      if is_data_flag else
                      cms.untracked.vstring('../../CMSSW_7_3_3/src/BaconProd/Utils/data/START53_V15_L1FastJet_AK5PF.txt',
                                            '../../CMSSW_7_3_3/src/BaconProd/Utils/data/START53_V15_L2Relative_AK5PF.txt',
                                            '../../CMSSW_7_3_3/src/BaconProd/Utils/data/START53_V15_L3Absolute_AK5PF.txt')
                    ),
